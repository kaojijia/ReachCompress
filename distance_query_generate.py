...
def find_pairs_within_distance(G, distances):
    """
    查找在给定距离内的点对。
...
def main(input_dir, output_dir, distances):
    ...
    for filename in os.listdir(input_dir):
        ...
        output_file = os.path.join(output_dir, f"{os.path.splitext(filename)[0]}_distance_pairs")
        ...
        # 查找在给定距离内的点对
        pairs_within_distance = find_pairs_within_distance(G, distances)
        print("Pairs found.")
